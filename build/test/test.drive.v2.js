...
describe('drive:v2', function () {
    ...
    describe('.files', function () {
        ...
        describe('.insert', function () {
            ...
            it('should not return a Request object', function (done) {
                var req = localDrive.files.insert({}, utils_1.Utils.noop);
        ...
        describe('.get', function () {
            ...
            it('should not return a Request object', function () {
                var req = localDrive.files.get({ fileId: '123' }, utils_1.Utils.noop);
                assert.equal(req, undefined);
            ...
            it('should use logError callback if no callback specified', function (done) {
                nock(utils_1.Utils.baseUrl).get('/drive/v2/files?q=hello').times(2).reply(501, {
    ...
    describe('.files.list()', function () {
        it('should not return missing param error', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        nock(utils_1.Utils.baseUrl).get('/drive/v2/files?q=hello').times(2).reply(200);
                        return [4 /*yield*/, pify(localDrive.files.list)({ q: 'hello' })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, pify(remoteDrive.files.list)({ q: 'hello' })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
