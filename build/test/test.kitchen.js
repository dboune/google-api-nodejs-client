...
var tmp = require("tmp");
var rename = pify(fs.rename);
var ncpp = pify(ncp_1.ncp);
var keep = !!process.env.GANC_KEEP_TEMPDIRS;
 ...
 */
describe('kitchen sink', function () { return __awaiter(_this, void 0, void 0, function () {
    var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, rename(tarball, stagingPath + "/googleapis.tgz")];
                    case 2:
                        _a.sent();
